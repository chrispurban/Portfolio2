  ...
  projects = [
    {
      ...
      desc:"Task management in the style of a Kanban board, a pun on Lean's 'takt time' and the use of a grid interface.\n\nFormating of each task encourages users to describe what weak points they've identified, rather than a predetermined solution; this helps to maintain scope/objectivity and open negotiating space when multiple teams get involved.\n\nLike recursion? Drop me an email to see how this app was used in its own development!"
    }
  ];
